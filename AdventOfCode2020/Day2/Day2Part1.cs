...
"1-18 c: ccdczcvccvclcccvkccb"};
        ...
        public static void Execute()
        {
            ...
            foreach (var password in passwords)
            {
                ...
                var letterNeeded = policy.Substring(length - 1);
        ...
        private static bool Validate(int digit1, int digit2, string letterNeeded, string password)
        {
            int count = Regex.Matches(password, letterNeeded).Count;
            return count >= digit1 && count <= digit2;
        }
    }
}